...
export default {
  ...
  setup() {
    ...
    // Submitted restock orders belong up top: loadOrders sorts ascending by
    // order_date, so a freshly submitted order lands at the end of the main
    // table where it would otherwise go unnoticed.
